      ...
      <ComponentContainer>
        <Grid>
          ...
          <ExampleCard>
            ...
            <Alert 
              type="info" 
              message="系统将于今晚22:00进行例行维护，预计耗时2小时。"
            />
          </ExampleCard>
