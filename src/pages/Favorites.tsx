...
import { FiHeart, FiCalendar, FiClock, FiTag, FiTrash2, FiEye, FiUser, FiMessageSquare, FiSearch } from 'react-icons/fi';
      ...
      >
        <FavoritesContainer>
          ...
          <TabsContainer>
            ...
            <Tab 
              active={activeTab === '文章'} 
              onClick={() => handleTabChange('文章')}
            >
              文章
            </Tab>
            <Tab 
              active={activeTab === '项目'} 
              onClick={() => handleTabChange('项目')}
            >
              项目
            </Tab>
            <Tab 
              active={activeTab === '话题'} 
              onClick={() => handleTabChange('话题')}
            >
              话题
            </Tab>
          </TabsContainer>
