...
const SHEEP_WIDTH = 48; // 稍微缩小适应 Dock
const SHEEP_HEIGHT = 60;

// 容器
const SheepContainer = styled(motion.div)`
    ...
    <SheepContainer>
      ...
      >
        ...
        <motion.path
          ...
          animate={clickCount > 0 ? 'excited' : 'normal'}
        />
        <path
